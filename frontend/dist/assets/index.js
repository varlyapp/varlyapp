...
class VueElement extends BaseClass {
  ...
  _update() {
    render$9(this._createVNode(), this.shadowRoot);
  }
  _createVNode() {
...
const useCollectionStore = defineStore("collection", () => {
  ...
  return { reset: reset2, traits, layers, directory, name, description, size: size2, width, height };
}, { persist: true });
const VarlySymbol$1 = "__VARLY__";
function useVarly$1() {
  return inject(VarlySymbol$1);
}
function createVarly() {
  return function install(app2) {
    const varly2 = reactive(new Varly(app2));
    app2.config.globalProperties.$varly = varly2;
    app2.provide(VarlySymbol$1, varly2);
  };
}
class Varly {
  constructor(vue) {
    ...
    __publicField(this, "appStore");
    __publicField(this, "collectionStore");
  ...
  async confirmStartNewProject(title, message) {
  ...
  getConfig() {
    const layers = __spreadValues({}, this.collectionStore.layers);
    ...
    const config = {
      Dir: "",
      Order: [...this.collectionStore.traits].map((item) => item.name),
      Layers: layers,
...
var LoggerType = /* @__PURE__ */ ((LoggerType2) => {
  LoggerType2["Debug"] = "Debug";
  LoggerType2["Error"] = "Error";
  LoggerType2["Fatal"] = "Fatal";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        type: "button",
        class: normalizeClass(["select-none flex min-w-full mt-2 py-2 px-4 items-center rounded hover:bg-slate-900 hover:bg-opacity-5 hover:dark:bg-slate-50 hover:dark:bg-opacity-5", [props.selected ? "bg-slate-900 bg-opacity-10 dark:bg-slate-50 dark:bg-opacity-5" : ""]]),
        onClick: handleClick
      }, [
        createBaseVNode("span", null, [
          (openBlock(), createBlock(resolveDynamicComponent(props.icon), { class: "w-6 mr-2 fill-fuchsia-700 dark:fill-fuchsia-500" }))
        ]),
  ...
  setup(__props) {
    ...
    const startNewProjectAction = () => {
      ...
      return async function() {
        if (await varly2.confirmStartNewProject(t(`confirm_start_new_project_title`), t(`confirm_start_new_project_message`))) {
          varly2.collectionStore.reset();
          router2.push({ name: "artwork.layers" });
        } else {
    ...
    const presets = {
      links: [
        ...
        { icon: render$8, text: t("follow_on_twitter"), to: () => launch("https://twitter.com/varlyapp"), selected: false },
        { icon: null, text: "Workspace", to: "", selected: false },
        { icon: render$4, text: t("recent_projects"), to: "start", selected: route.name === "start" },
        { icon: render$5, text: t("start_new_project"), to: startNewProjectAction(), selected: false }
      ]
    };
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(buttons), (link, i) => {
              return openBlock(), createElementBlock("li", { key: i }, [
                link.icon ? (openBlock(), createBlock(_sfc_main$b, {
                  ...
                  icon: link.icon
                }, null, 8, ["text", "to", "selected", "icon"])) : (openBlock(), createElementBlock("h2", _hoisted_3$7, toDisplayString$1(link.text), 1))
              ]);
            }), 128))
          ])
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    onBeforeMount(async () => {
      const settings = await varly2.getSettings();
          ...
          createBaseVNode("section", _hoisted_3$6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(documents).value, (document2, i) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("h2", _hoisted_5$5, toDisplayString$1(document2.title), 1)
              ]);
            }), 128))
          ])
        ])
...
const _hoisted_4$4 = { class: "max-w-4xl mx-auto px-8 py-16 xl:py-32" };
const _hoisted_5$4 = { class: "p-4 lg:p-8" };
const _hoisted_6$4 = { class: "flex items-center justify-between bg-slate-900 bg-opacity-20 dark:bg-opacity-20" };
...
const _hoisted_16$1 = { class: "h-full p-4 lg:p-8 flex items-center justify-center text-center" };
const _hoisted_17$1 = /* @__PURE__ */ createBaseVNode("svg", {
...
const _hoisted_18$1 = /* @__PURE__ */ createBaseVNode("h3", { class: "mt-2 text-sm font-medium" }, "No Projects", -1);
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    async function loadLayers() {
      collectionStore.directory = await varly2.openDirectoryDialog();
      const config = await varly2.app.ReadLayers(collectionStore.directory);
      collectionStore.layers = __spreadValues({}, config.Layers);
      const traits = [];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$6, [
        ...
        createBaseVNode("main", _hoisted_2$6, [
          unref(collectionStore) && unref(collectionStore).layers && Object.keys(unref(collectionStore).layers).length ? (openBlock(), createElementBlock("section", _hoisted_3$5, [
            createBaseVNode("div", _hoisted_4$4, [
              createVNode(unref(draggable), {
                ...
                group: "trait",
                modelValue: unref(collectionStore).traits,
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(collectionStore).traits = $event),
                "force-fallback": true,
                onStart: _cache[3] || (_cache[3] = ($event) => isTraitDragging.value = true),
                onEnd: _cache[4] || (_cache[4] = ($event) => isTraitDragging.value = false),
                "item-key": "name"
              }, {
                    ...
                    createBaseVNode("div", _hoisted_6$4, [
                      createBaseVNode("div", _hoisted_7$4, [
                        createBaseVNode("button", {
                          ...
                          onClick: ($event) => toggleCollapsed(element)
                        }, [
                          element.collapsed ? (openBlock(), createElementBlock("span", _hoisted_9$2, "\u21E3")) : (openBlock(), createElementBlock("span", _hoisted_10$2, "\u21E1"))
                        ], 8, _hoisted_8$2),
                        createBaseVNode("h1", {
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("input", {
                          ...
                          type: "text",
                          value: `${weightDistributionTotal(unref(collectionStore).layers[element.name])}`
                        }, null, 8, _hoisted_12$1)
                      ])
                    ]),
                    createVNode(unref(draggable), {
                      class: normalizeClass(element.collapsed || isCollapsed.value ? "hidden" : "block"),
                      group: "layer",
                      "force-fallback": true,
                      list: unref(collectionStore).layers[element.name],
                      onStart: _cache[0] || (_cache[0] = ($event) => isLayerDragging.value = true),
                      onEnd: _cache[1] || (_cache[1] = ($event) => isLayerDragging.value = false),
                      "item-key": "name"
                    }, {
                      item: withCtx(({ element: element2, index: index2 }) => [
                        (openBlock(), createElementBlock("div", {
                          key: element2.Name,
                          class: normalizeClass(["min-w-full flex justify-between border-slate-900 dark:border-slate-50 border-opacity-20 dark:border-opacity-20", [index2 % 2 === 0 ? `bg-slate-900 dark:bg-slate-100 bg-opacity-10 dark:bg-opacity-5` : `bg-slate-800 dark:bg-slate-400 bg-opacity-5 dark:bg-opacity-5`]])
                        }, [
                          createBaseVNode("div", {
                            class: "whitespace-nowrap py-2 px-4 text-sm font-medium sm:px-6 lg:px-8",
                            textContent: toDisplayString$1(element2.Name)
                          }, null, 8, _hoisted_13$1),
                          createBaseVNode("div", {
                            class: "whitespace-nowrap py-2 px-4 text-sm",
                            textContent: toDisplayString$1(element2.Weight)
          ...
          ])) : (openBlock(), createElementBlock("section", _hoisted_15$1, [
              ...
              createBaseVNode("div", null, [
                ...
                createBaseVNode("div", _hoisted_20$1, [
                  createBaseVNode("button", {
                    ...
                    onClick: _cache[5] || (_cache[5] = ($event) => loadLayers())
                  }, [
      ...
      return openBlock(), createElementBlock("section", _hoisted_1$5, [
        createVNode(_sfc_main$a, {
          links: [
            ...
            { icon: unref(render$4), text: "Recent Projects", to: "start", selected: false },
            { icon: unref(render$5), text: "Start New Project", to: "artwork.layers", selected: false },
            { icon: null, text: "", to: "", selected: false },
              ...
              createBaseVNode("div", _hoisted_5$3, [
                ...
                createBaseVNode("div", _hoisted_7$3, [
                  withDirectives(createBaseVNode("input", {
                    ...
                    autocomplete: "none",
                    autofocus: "",
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(store).name = $event)
                  }, null, 512), [
                    [vModelText, unref(store).name]
                  ])
                ])
              ])
            ])
...
const _hoisted_7$2 = { class: "mt-1" };
const _hoisted_8$1 = { class: "col-span-12" };
        ...
        for (const trait in Object.keys(store.layers)) {
          if (store.layers.hasOwnProperty(trait)) {
            if (store.layers[trait] && store.layers[trait].length) {
              ...
              if (image) {
                const stats = await varly2.stat(image);
                console.log(stats);
              }
            }
          }
              ...
              createBaseVNode("div", _hoisted_8$1, [
                ...
                createBaseVNode("div", _hoisted_10$1, [
                  withDirectives(createBaseVNode("textarea", {
                    ...
                    autocomplete: "none",
                    autofocus: "",
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(store).description = $event)
                  }, null, 512), [
                    [vModelText, unref(store).description]
                  ])
                ])
              ]),
              _hoisted_11,
              createBaseVNode("div", _hoisted_12, [
                ...
                createBaseVNode("div", _hoisted_14, [
                  withDirectives(createBaseVNode("input", {
                    ...
                    autocomplete: "none",
                    class: "field",
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(store).width = $event)
                  }, null, 512), [
                    [vModelText, unref(store).width]
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_15, [
                ...
                createBaseVNode("div", _hoisted_17, [
                  withDirectives(createBaseVNode("input", {
                    ...
                    autocomplete: "none",
                    class: "field",
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => unref(store).height = $event)
                  }, null, 512), [
                    [vModelText, unref(store).height]
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_18, [
                ...
                createBaseVNode("div", _hoisted_20, [
                  withDirectives(createBaseVNode("input", {
                    ...
                    autocomplete: "none",
                    class: "field",
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => unref(store).size = $event)
                  }, null, 512), [
                    [vModelText, unref(store).size]
                  ])
                ])
              ]),
              _hoisted_21
...
const CRAZY_PARTICLE_CRAZINESS = 0.3;
const BEZIER_MEDIAN = 0.5;
const FORCE = 0.5;
const SIZE = 12;
const FLOOR_HEIGHT = 800;
const FLOOR_WIDTH = 1600;
...
var script = {
  ...
  setup(props) {
    ...
    watchEffect(() => {
      props.particleCount > 300 && console.log("[VUE-CONFETTI-EXPLOSION] That's a lot of confetti, you sure about that? A lesser number like 200 will still give off the party vibes while still not bricking the device \u{1F609}");
    });
    ...
    const waitFor = (ms) => new Promise((resolve2) => setTimeout(resolve2, ms));
    function round(num) {
...
var entry_esm = /* @__PURE__ */ (() => {
  ...
  installable.install = (app2) => {
    app2.component("ConfettiExplosion", installable);
  };
  return installable;
})();
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const completed = computed(() => {
      let completed2 = parseInt(props.currentStep, 10) / parseInt(props.steps, 10) * 100;
      if (isNaN(completed2)) {
        completed2 = 0;
      }
        ...
        createBaseVNode("div", _hoisted_2$3, [
          ...
          createBaseVNode("div", _hoisted_7$1, [
            createBaseVNode("div", {
              ...
              style: normalizeStyle({ width: `${unref(completed)}%` })
            }, null, 4)
          ])
        ])
      ]);
...
const _hoisted_2 = { class: "h-full flex-1 overflow-y-scroll scrollbar-none" };
const _hoisted_3 = {
  key: 0,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    function queueConfetti() {
      ...
      setTimeout(() => {
        isDone.value = false;
        varly2.runtime.LogInfo("Setting isDone to false");
      }, 5e3);
    }
    ...
    async function generateCollection() {
      ...
      const outputDirectory = await varly2.openDirectoryDialog();
      if (!outputDirectory)
        return;
      toggleIsWorking();
      const layers = __spreadValues({}, store.layers);
      ...
      await varly2.app.GenerateNewCollectionFromConfig(config);
      toggleIsWorking();
      queueConfetti();
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1, [
        createVNode(_sfc_main$a, {
          links: [
            { icon: unref(render$6), text: "Layer Setup", to: "artwork.layers", selected: false },
            { icon: unref(render$7), text: "Build Settings", to: "artwork.build", selected: false },
            { icon: unref(render$3), text: "Run", to: "artwork.run", selected: true }
          ]
        }, null, 8, ["links"]),
        ...
        isDone.value ? (openBlock(), createBlock(unref(entry_esm), {
          key: 0,
          "particle-count": 200,
          "particle-size": 10,
          duration: 5e3,
...
var lang = {
  ...
  messages: {
    en: {
      ...
      ready_to_run: "You are ready to generate your beautiful NFT collection\u{1F680}",
    ...
    es: {
      ...
      follow_on_twitter: "S\xEDguenos en Twitter",
      recent_projects: "Proyectos Recientes",
      start_new_project: "Crear Proyecto Nuevo",
      layer_setup: "Configuraci\xF3n de Capas",
      build_settings: "Ajustes de Construcci\xF3n",
      run: "Correr",
      next: "S\xEDgue",
      collection_name: "Nombre de colecci\xF3n",
      collection_description: "Descripcion de colecci\xF3n",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    router2.beforeResolve((to) => {
      setIsOnStartScreen(to);
    });
    return (_ctx, _cache) => {
      const _component_router_view = resolveComponent("router-view");
      return openBlock(), createBlock(_component_router_view, { class: "relative h-full overflow-hidden" });
    };
  }
});
var animate = "";
...
createApp(_sfc_main).use(router).use(pinia).use(intl).use(varly).mount("#app");
